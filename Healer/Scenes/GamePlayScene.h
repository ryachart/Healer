...
@interface GamePlayScene : CCScene <EventLogger, Announcer, GamePlayFTUELayerDelegate, PauseLayerDelegate, GKMatchDelegate, IconDescriptorModalDelegate, AbilityDescriptionViewDelegate>
//Interface Elements
