    ...
    if (self){
        ...
        if (victory){
            ...
            if (enc.levelNumber != 1) {
                self.scoreLabel = [CCLabelTTFShadow labelWithString:@"Score: " dimensions:CGSizeMake(350, 50) hAlignment:kCCTextAlignmentLeft fontName:@"TrebuchetMS-Bold" fontSize:36.0];
