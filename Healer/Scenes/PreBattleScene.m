...
- (id)initWithEncounter:(Encounter*)enc andPlayer:(Player*)player {
    if (self = [super init]){
        ...
        if (self.encounter.info){
            ...
            CCLabelTTF *bossLabel = [CCLabelTTF labelWithString:self.encounter.info dimensions:CGSizeMake(300, 500) hAlignment:kCCTextAlignmentLeft fontName:@"Cochin-BoldItalic" fontSize:20.0];
