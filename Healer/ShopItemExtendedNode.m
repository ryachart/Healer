...
- (id)initWithShopItem:(ShopItem *)itm{
    if (self = [super init]){
        ...
        self.itemName = [CCLabelTTF labelWithString:self.item.title dimensions:CGSizeMake(300, 40) hAlignment:kCCTextAlignmentLeft fontName:@"Arial" fontSize:32.0];
        ...
        self.itemDescription = [CCLabelTTF labelWithString:self.item.purchasedSpell.spellDescription dimensions:CGSizeMake(300, 300) hAlignment:kCCTextAlignmentCenter fontName:@"Arial" fontSize:18.0];
