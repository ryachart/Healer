...
-(id)initWithSpell:(Spell*)spell{
    if (self = [super init]){
        ...
        CCLabelTTF *spellNamePH = [CCLabelTTF labelWithString:spell.title dimensions:CGSizeMake(100, 100) hAlignment:UITextAlignmentCenter fontName:@"Arial" fontSize:24.0];
        ...
        CCLabelTTF *spellDetailsLabel = [CCLabelTTF labelWithString:spell.info dimensions:CGSizeMake(200, 70) hAlignment:UITextAlignmentLeft fontName:@"Arial" fontSize:14];
        [spellDetailsLabel setColor:ccBLACK];
        [spellDetailsLabel setPosition:ccp(102,38)];
        
        CCLabelTTF *spellCastTimeLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Cast Time: %1.2f", spell.castTime] dimensions:CGSizeMake(200, 20) hAlignment:UITextAlignmentLeft fontName:@"Arial" fontSize:14];
        [spellCastTimeLabel setColor:ccBLACK];
        [spellCastTimeLabel setPosition:ccp(102, 90)];
        
        CCLabelTTF *spellCooldownLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"Cooldown: %1.2f", spell.cooldown] dimensions:CGSizeMake(200, 40) hAlignment:UITextAlignmentLeft fontName:@"Arial" fontSize:14];
