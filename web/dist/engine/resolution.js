...
function getLevelValue(values, level) {
    return values[String(level)] ?? 0;
}
function totalRatingForProgression(registry, ratingsByLevel) {
...
function unlockedTalentTiers(registry, totalRating) {
...
function rarityValueForId(equipmentSchema, rarityId) {
...
function calculateGoldReward(registry, state, highestLevelCompleted) {
...
export function resolveEncounterOutcome(registry, state, progressionInput = {}) {
